...
<html lang="es">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">Actualizar</a></li>
    ...
    GetActualizarIncidente("$ID", "$tipo", "$incidente", "$area", "$causa", "$gestion", "$solucion", "$estado"); 
  ...
  <div class="container">
    <div class="starter-template">
      <div class="formulario">
        <h1><font color="#3399cc">Incidente Actualizado</h1></font></br>
        ...
        <a href="../categorias/gestionar.php"><input type="button" class="button" value="Gestionar Otro"></a>
