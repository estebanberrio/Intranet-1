  ...
  header('Content-Disposition: attachment;filename="Reporte_Incidentes"');
  //header("Cache-Control: max-age=0");
  
  //Propiedades de Documento
  $objPHPExcel->getProperties()->setCreator("Automatico")->setDescription("Reporte Incidentes");
  ...
  $objPHPExcel->getActiveSheet()->getStyle('A2:K7')->applyFromArray($estiloTituloColumnas);
  ...
  //$writer = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007'); //op1
  $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007'); //op2
